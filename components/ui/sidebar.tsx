        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                      ...
                      <div className="lg:sidebar-expanded:block lg:hidden 2xl:block">
                        <ul className={`mt-1 pl-8 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/saas">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                SaaS
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/ecommerce">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Ecommerce
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/marketing">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Marketing
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/crm">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                CRM
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/support">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Support
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/monitoring">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Monitoring
                              </span>
                            </SidebarLink>
              ...
              {/* E-Commerce */}
              <SidebarLinkGroup open={segments[0] === "ecommerce"}>
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments[0] === "ecommerce" ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg
                              className={`shrink-0 fill-current ${segments[0] === "ecommerce" ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
                              height="16"
                              viewBox="0 0 16 16"
                      ...
                      <div className="lg:sidebar-expanded:block lg:hidden 2xl:block">
                        <ul className={`mt-1 pl-8 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/ecommerce/customers/0">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Customer Detail
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/ecommerce/customers/new">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Add Customer
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/ecommerce/orders/0">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Order Detail
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/ecommerce/orders/new">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Add Order
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/ecommerce/invoices/0">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Invoice Detail
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/ecommerce/invoices/new">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Create Invoice
                              </span>
                            </SidebarLink>
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("community") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      <div className="lg:sidebar-expanded:block lg:hidden 2xl:block">
                        <ul className={`mt-1 pl-8 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/community/users-list">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Users - List
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/community/add-user">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Add Member
                              </span>
                            </SidebarLink>
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("finance") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      <div className="lg:sidebar-expanded:block lg:hidden 2xl:block">
                        <ul className={`mt-1 pl-8 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/finance/transactions/0">
                              <span className="lg:sidebar-expanded:opacity-100 text-sm font-medium duration-200 lg:opacity-0 2xl:opacity-100">
                                Transaction Detail
                              </span>
                            </SidebarLink>
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("jobs") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg
                              className={`shrink-0 fill-current ${segments.includes("jobs") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
                              height="16"
                              viewBox="0 0 16 16"
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("tasks") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg
                              className={`shrink-0 fill-current ${segments.includes("tasks") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
                              height="16"
                              viewBox="0 0 16 16"
              ...
              {/* Messages */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${segments.includes("messages") && "from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]"}`}
              >
                <SidebarLink href="/messages">
                  <div className="flex items-center justify-between">
                    <div className="flex grow items-center">
                      <svg
                        className={`shrink-0 fill-current ${segments.includes("messages") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
              ...
              {/* Inbox */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${segments.includes("inbox") && "from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]"}`}
              >
                <SidebarLink href="/inbox">
                  <div className="flex items-center">
                    <svg
                      className={`shrink-0 fill-current ${segments.includes("inbox") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
              ...
              {/* Calendar */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${segments.includes("calendar") && "from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]"}`}
              >
              ...
              {/* Campaigns */}
              <li
                className={`mb-0.5 rounded-lg bg-linear-to-r py-2 pr-3 pl-4 last:mb-0 ${segments.includes("campaigns") && "from-violet-500/[0.12] to-violet-500/[0.04] dark:from-violet-500/[0.24]"}`}
              >
                <SidebarLink href="/campaigns">
                  <div className="flex items-center">
                    <svg
                      className={`shrink-0 fill-current ${segments.includes("campaigns") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("settings") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("utility") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${open ? "" : "hover:text-gray-900 dark:hover:text-white"}`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                        }}
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block truncate text-gray-800 transition dark:text-gray-100 ${
                          segments.includes("components-library") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg
                              className={`shrink-0 fill-current ${segments.includes("components-library") ? "text-violet-500" : "text-gray-400 dark:text-gray-500"}`}
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
                              height="16"
                              viewBox="0 0 16 16"
