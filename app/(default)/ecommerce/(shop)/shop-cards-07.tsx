...
export default function ShopCards07() {
  return (
    <>
      {/* Card 1 */}
      <div className="col-span-full overflow-hidden rounded-xl bg-white shadow-sm md:col-span-6 xl:col-span-4 dark:bg-gray-800">
      ...
      <div className="col-span-full md:order-1 xl:order-none">
        <div className="h-full rounded-lg bg-gray-900 p-6 text-center xl:flex xl:items-center xl:justify-between xl:text-left dark:bg-gray-800">
          <div className="mb-4 xl:mr-4 xl:mb-0">
            <div className="mb-1 text-xl font-semibold text-gray-50">Excepteur sint occaecat cupidatat 🎁</div>
          ...
          <button className="btn shrink-0 bg-gray-100 text-gray-800 hover:bg-white">Reedem Now!</button>
        </div>
      </div>
