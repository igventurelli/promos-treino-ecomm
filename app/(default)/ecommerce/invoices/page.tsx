    ...
    <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-5 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl font-bold text-gray-800 md:text-3xl dark:text-gray-100">Invoices</h1>
        </div>

        {/* Right: Actions */}
        <div className="grid grid-flow-col justify-start gap-2 sm:auto-cols-max sm:justify-end">
          {/* Search form */}
          <DataTableSearch placeholder="Search by invoice ID…" />
          {/* Create invoice button */}
          <Link
            href="/ecommerce/invoices/new"
      ...
      <div className="mb-5 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="grid grid-flow-col justify-start gap-2 sm:auto-cols-max sm:justify-end">
          ...
          <DataTableDateSelect />
          {/* Filter button */}
          <DataTableFilter columnId="status" options={statusOptions} align="right" />
        </div>
      </div>
