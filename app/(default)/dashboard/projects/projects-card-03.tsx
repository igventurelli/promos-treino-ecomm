...
export default function ProjectsCard03() {
  const chartData = {
    labels: [
      "12-01-2022",
      "01-01-2023",
    ...
    datasets: [
      {
        data: [72, 74, 76, 78, 79, 81, 80, 82, 84, 83, 85, 86, 87, 88, 89, 90, 88, 91, 92, 91, 93, 94, 93, 95, 94, 96],
        fill: true,
      ...
      {
        data: [68, 69, 70, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 83, 85, 86, 87, 86, 88, 89, 88, 90, 91],
    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header className="mb-2 flex items-start justify-between">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Team Utilization</h2>
          {/* Menu button */}
          <EditMenu align="right" />
        </header>
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">Capacity</div>
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">96%</div>
