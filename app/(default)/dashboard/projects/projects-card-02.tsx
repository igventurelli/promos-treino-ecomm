...
export default function ProjectsCard02() {
  const chartData = {
    labels: [
      "12-01-2022",
      "01-01-2023",
    ...
    datasets: [
      {
        data: [
          142, 158, 171, 165, 189, 203, 198, 215, 228, 241, 235, 252, 268, 274, 289, 301, 295, 318, 332, 345, 338, 356,
          371, 364, 382, 398,
        ],
        fill: true,
      ...
      {
        data: [
          128, 135, 148, 152, 160, 175, 168, 182, 190, 205, 198, 210, 225, 232, 240, 255, 248, 262, 275, 288, 280, 295,
          310, 302, 318, 330,
        ],
    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header className="mb-2 flex items-start justify-between">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Tasks Completed</h2>
          {/* Menu button */}
          <EditMenu align="right" />
        </header>
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">This Quarter</div>
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">398</div>
