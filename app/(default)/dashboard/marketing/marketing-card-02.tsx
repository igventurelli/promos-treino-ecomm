...
export default function MarketingCard02() {
  const chartData = {
    labels: [
      "12-01-2022",
      "01-01-2023",
    ...
    datasets: [
      {
        data: [
          842, 876, 910, 948, 982, 1014, 1048, 1082, 1124, 1168, 1202, 1246, 1288, 1324, 1368, 1412, 1456, 1498, 1542,
          1588, 1634, 1682, 1728, 1776, 1824, 1872,
        ],
        fill: true,
      ...
      {
        data: [
          720, 738, 756, 774, 792, 808, 826, 844, 862, 880, 898, 916, 934, 952, 970, 988, 1006, 1024, 1042, 1060, 1078,
          1096, 1114, 1132, 1150, 1168,
        ],
    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header className="mb-2 flex items-start justify-between">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Conversions</h2>
          {/* Menu button */}
          <EditMenu align="right" />
        </header>
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">Total Conversions</div>
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">1,872</div>
