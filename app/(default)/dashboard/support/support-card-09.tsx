...
export default function SupportCard09() {
  const chartData = {
    labels: ["Urgent", "High", "Medium", "Low"],
    datasets: [
      {
        label: "Satisfaction by Priority",
        data: [82, 88, 91, 94],
        backgroundColor: [
          adjustColorOpacity(getCssVariable("--color-red-500"), 0.8),
        ...
        hoverBackgroundColor: [
          adjustColorOpacity(getCssVariable("--color-red-600"), 0.8),
  ...
  return (
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 dark:bg-gray-800">
      <header className="border-b border-gray-100 px-5 py-4 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Satisfaction by Priority</h2>
      </header>
      {/* Chart built with Chart.js 3 */}
      {/* Change the height attribute to adjust the chart height */}
      <PolarChart data={chartData} width={595} height={260} />
    </div>
  );
}
