    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 dark:bg-gray-800">
      ...
      <div className="px-5 py-3">
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">+$6,796</div>
          <div className="rounded-full bg-red-500/20 px-1.5 text-sm font-medium text-red-700">-34%</div>
        </div>
      </div>
