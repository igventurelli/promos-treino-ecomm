...
export default function EcommerceCard02() {
  const chartData = {
    labels: [
      "12-01-2022",
      "01-01-2023",
    ...
    datasets: [
      {
        data: [
          842, 891, 864, 912, 948, 921, 976, 1004, 988, 1032, 1068, 1094, 1128, 1106, 1142, 1178, 1214, 1196, 1238,
          1274, 1308, 1334, 1368, 1402, 1436, 1458,
        ],
        fill: true,
      ...
      {
        data: [
          768, 792, 781, 804, 822, 814, 836, 848, 842, 862, 878, 891, 908, 896, 918, 934, 948, 941, 962, 978, 992, 1004,
          1022, 1038, 1054, 1068,
        ],
    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header className="mb-2 flex items-start justify-between">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Total Orders</h2>
          {/* Menu button */}
          <EditMenu align="right" />
        </header>
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">Orders</div>
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">12,458</div>
