  ...
  const chartData = {
    ...
    datasets: [
      // Indigo line
      {
        label: "Current",
        data: [
          5000, 8700, 7500, 12000, 11000, 9500, 10500, 10000, 15000, 9000, 10000, 7000, 22000, 7200, 9800, 9000, 10000,
          8000, 15000, 12000, 11000, 13000, 11000, 15000, 17000, 18000,
        ],
        fill: true,
      ...
      // Gray line
      {
        label: "Previous",
        data: [
          8000, 5000, 6500, 5000, 6500, 12000, 8000, 9000, 8000, 8000, 12500, 10000, 10000, 12000, 11000, 16000, 12000,
          10000, 10000, 14000, 9000, 10000, 15000, 12500, 14000, 11000,
        ],
      ...
      <div className="px-5 py-1">
        <div className="flex flex-wrap max-sm:*:w-1/2">
          ...
          <div className="flex items-center py-2">
            ...
            <div className="mr-5 hidden h-8 w-px bg-gray-200 md:block dark:bg-gray-700" aria-hidden="true"></div>
          </div>
          {/* Total Pageviews */}
          <div className="flex items-center py-2">
            <div className="mr-5">
