...
export default function FintechCard13() {
  ...
  return (
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-3 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header>
          <h3 className="mb-1 text-sm font-semibold text-gray-500 uppercase">
