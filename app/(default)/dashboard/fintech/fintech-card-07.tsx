...
export default function FintechCard06() {
  const chartData = {
    ...
    datasets: [
      // Indigo line
      {
        ...
        data: [
          1500, 2000, 1800, 1900, 1900, 2400, 2900, 2600, 3900, 2700, 3500, 3200, 2900, 3500, 3600, 3400, 3900, 3600,
          4100, 4100,
        ],
  ...
  return (
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-12 xl:col-span-4 dark:bg-gray-800">
      ...
      <div className="px-5 py-3">
        ...
        <div className="flex items-center">
          ...
          <div className="text-sm">
            <span className="font-medium text-yellow-600">97.4%</span>
          </div>
        </div>
