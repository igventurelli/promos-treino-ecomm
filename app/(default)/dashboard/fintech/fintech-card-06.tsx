    ...
    <div className="col-span-full rounded-xl bg-white shadow-sm xl:col-span-6 dark:bg-gray-800">
      ...
      <div className="p-3">
          ...
          <table className="w-full table-auto dark:text-gray-300">
            ...
            <tbody className="divide-y divide-gray-100 text-sm dark:divide-gray-700/60">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-right font-medium text-green-600">+$1,299.22</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-right font-medium text-green-600">+$1,200.88</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-right font-medium text-green-600">+$499.99</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-right font-medium text-green-600">+$2,179.36</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="mr-2 shrink-0 rounded-full bg-red-500 sm:mr-3">
                      <svg className="h-9 w-9 fill-current text-white" viewBox="0 0 36 36">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-right font-medium text-green-600">+$249.88</div>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="border-t border-gray-100 px-2 text-center dark:border-gray-700/60">
          <a
            className="block pt-4 pb-1 text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400"
            href="#0"
          >
            View All -&gt;
          </a>
