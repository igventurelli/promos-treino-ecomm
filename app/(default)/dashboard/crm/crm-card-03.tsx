...
export default function CrmCard03() {
  const chartData = {
    labels: [
      "12-01-2022",
      "01-01-2023",
    ...
    datasets: [
      {
        data: [22, 24, 23, 25, 26, 27, 28, 29, 30, 31, 30, 32, 33, 34, 33, 35, 36, 35, 37, 38, 37, 39, 40, 41, 42, 44],
        fill: true,
      ...
      {
        data: [20, 21, 20, 22, 23, 24, 25, 26, 27, 28, 27, 29, 30, 31, 30, 32, 33, 32, 34, 35, 34, 36, 37, 38, 39, 40],
    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header className="mb-2 flex items-start justify-between">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Win Rate</h2>
          {/* Menu button */}
          <EditMenu align="right" />
        </header>
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">This Quarter</div>
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">44%</div>
          <div className="rounded-full bg-green-500/20 px-1.5 text-sm font-medium text-green-700">+3%</div>
        </div>
      </div>
