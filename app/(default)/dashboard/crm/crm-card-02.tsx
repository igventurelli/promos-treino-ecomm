...
export default function CrmCard02() {
  const chartData = {
    labels: [
      "12-01-2022",
      "01-01-2023",
    ...
    datasets: [
      {
        data: [12, 14, 11, 15, 16, 18, 17, 19, 21, 20, 22, 24, 23, 26, 25, 28, 27, 30, 29, 32, 31, 34, 33, 36, 38, 42],
        fill: true,
      ...
      {
        data: [10, 11, 9, 12, 13, 14, 13, 15, 16, 15, 17, 18, 17, 19, 18, 20, 19, 21, 20, 22, 21, 23, 22, 24, 25, 26],
    ...
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-sm sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
      <div className="px-5 pt-5">
        <header className="mb-2 flex items-start justify-between">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Deals Won</h2>
          {/* Menu button */}
          <EditMenu align="right" />
        </header>
        <div className="mb-1 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">This Quarter</div>
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">42</div>
