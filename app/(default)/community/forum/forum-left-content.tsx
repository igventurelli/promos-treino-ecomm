export default function ForumLeftContent() {
  return (
    <div className="mb-8 w-full md:mb-0 md:w-[15rem]">
      <div className="no-scrollbar md:sticky md:top-16 md:h-[calc(100dvh-64px)] md:overflow-x-hidden md:overflow-y-auto">
        <div className="md:py-8">
          <div className="flex items-center justify-between md:block">
            {/* Title */}
            <header className="mb-6">
              <h1 className="text-2xl font-bold text-gray-800 md:text-3xl dark:text-gray-100">Forum</h1>
            </header>

            {/* Button */}
            <div className="mb-6 xl:hidden">
              <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 md:w-full dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
                Create Post
              </button>
            </div>
          </div>
          ...
          <div className="no-scrollbar -mx-4 flex flex-nowrap overflow-x-scroll px-4 md:block md:space-y-3 md:overflow-auto">
            {/* Group 1 */}
            <div>
              <div className="mb-3 text-xs font-semibold text-gray-400 uppercase md:sr-only dark:text-gray-500">
                Menu
              </div>
              <ul className="mr-3 flex flex-nowrap md:mr-0 md:block">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a
                    className="flex items-center rounded-lg bg-white px-2.5 py-2 whitespace-nowrap dark:bg-gray-800"
                    href="#0"
                  >
                    <svg
                      className="mr-2 shrink-0 fill-current text-violet-500"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                    >
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center rounded-lg px-2.5 py-2 whitespace-nowrap" href="#0">
                    <svg
            ...
            {/* Group 2 */}
            <div>
              <div className="mb-3 text-xs font-semibold text-gray-400 uppercase dark:text-gray-500">My Groups</div>
              <ul className="mr-3 flex flex-nowrap md:mr-0 md:block">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center rounded-lg px-2.5 py-2 whitespace-nowrap" href="#0">
                    <svg className="mr-3 h-3 w-3 shrink-0 fill-current text-green-500" viewBox="0 0 12 12">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center rounded-lg px-2.5 py-2 whitespace-nowrap" href="#0">
                    <svg className="mr-3 h-3 w-3 shrink-0 fill-current text-red-500" viewBox="0 0 12 12">
                      <path d="M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z" />
                    </svg>
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center rounded-lg px-2.5 py-2 whitespace-nowrap" href="#0">
                    <svg className="mr-3 h-3 w-3 shrink-0 fill-current text-yellow-500" viewBox="0 0 12 12">
                      <path d="M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z" />
                    </svg>
