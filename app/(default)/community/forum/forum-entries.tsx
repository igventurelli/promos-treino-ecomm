    ...
    <>
      ...
      <article className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
        <div className="flex-start flex space-x-4">
          ...
          <div className="shrink-0">
            <button className="flex h-12 w-12 flex-col items-center justify-center rounded-lg border border-violet-500/60 text-center text-xs font-semibold shadow-violet-500/20">
              <svg
      ...
      <article className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
        <div className="flex-start flex space-x-4">
          {/* Avatar */}
          <div className="mt-1.5 shrink-0">
            <Image className="h-8 w-8 rounded-full" src={SponsorImg} width={32} height={32} alt="Crypto" />
          </div>
          {/* Content */}
          <div className="grow">
            {/* Title */}
