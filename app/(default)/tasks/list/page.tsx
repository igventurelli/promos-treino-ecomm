    ...
    <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-3xl">
          ...
          <div className="grid grid-flow-col justify-start gap-4 sm:auto-cols-max sm:justify-end">
            ...
            <div className="-ml-px flex shrink-0 -space-x-3">
              <a className="block" href="#0">
                <Image
                  className="box-content rounded-full border-2 border-gray-100 dark:border-gray-900"
                  src={UserImage08}
                  width="32"
                  height="32"
                  alt="User 08"
              ...
              <button className="ml-2 flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white text-violet-500 shadow-sm transition hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:hover:border-gray-600">
        ...
        <div className="space-y-6">
          {/* Group 1 */}
          <div>
            <h2 className="mb-4 grow truncate font-semibold text-gray-800 dark:text-gray-100">To Do's</h2>
            <div className="space-y-2">
              {/* Task */}
              <div className="rounded-xl bg-white p-4 shadow-sm dark:bg-gray-800" draggable="true">
                <div className="sm:flex sm:items-start sm:justify-between">
                  {/* Left side */}
                  <div className="mt-0.5 mb-3 grow space-y-3 sm:mb-0">
                    <div className="flex items-center">
                      {/* Drag button */}
                      <button className="mr-2 cursor-move">
                        <span className="sr-only">Drag</span>
                        <svg
                          className="h-3 w-3 fill-gray-400 dark:fill-gray-500"
                          viewBox="0 0 12 12"
                      ...
                      <label className="flex items-center">
                        <input type="checkbox" className="form-checkbox peer h-5 w-5 rounded-full" />
                        <span className="ml-2 font-medium text-gray-800 peer-checked:line-through dark:text-gray-100">
                  ...
                  <div className="flex items-center justify-end space-x-3">
                    ...
                    {/* Like button */}
                    <button className="flex items-center text-gray-400 hover:text-violet-500 dark:text-gray-500 dark:hover:text-violet-500">
                      <svg className="mr-1.5 shrink-0 fill-current" width="16" height="16" viewBox="0 0 16 16">
          ...
          {/* Group 2 */}
          <div>
            <h2 className="mb-4 grow truncate font-semibold text-gray-800 dark:text-gray-100">In Progress</h2>
            <div className="space-y-2">
              {/* Task */}
              <div className="rounded-xl bg-white p-4 shadow-sm dark:bg-gray-800" draggable="true">
                <div className="sm:flex sm:items-start sm:justify-between">
                  ...
                  <div className="mt-0.5 mb-3 grow space-y-3 sm:mb-0">
                    ...
                    <ul className="space-y-3 pl-12">
                      <li>
                        <label className="flex items-center">
                          <input type="checkbox" className="form-checkbox peer h-5 w-5 rounded-full" defaultChecked />
                          <span className="ml-3 text-sm text-gray-800 peer-checked:line-through dark:text-gray-100">
          ...
          {/* Group 3 */}
          <div>
            <h2 className="mb-4 grow truncate font-semibold text-gray-800 dark:text-gray-100">Completed</h2>
            <div className="space-y-2">
              {/* Task */}
              <div className="rounded-xl bg-white p-4 opacity-60 shadow-sm dark:bg-gray-800" draggable="true">
                <div className="sm:flex sm:items-start sm:justify-between">
                  {/* Left side */}
                  <div className="mt-0.5 mb-3 grow space-y-3 sm:mb-0">
                    <div className="flex items-center">
