  ...
  return (
    <div className="rounded-xl bg-white p-4 shadow-sm dark:bg-gray-800">
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button className="shrink-0 rounded-full border border-gray-200 bg-white p-2 text-violet-500 transition hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:hover:border-gray-600">
        ...
        <div className="flex items-center">
          ...
          {/* Replies button */}
          <button className="ml-3 flex items-center text-gray-400 hover:text-violet-500 dark:text-gray-500 dark:hover:text-violet-500">
            <svg className="mr-1.5 shrink-0 fill-current" width="16" height="16" viewBox="0 0 16 16">
