...
export default function Task04() {
  return (
    <div className="rounded-xl bg-white p-4 shadow-sm dark:bg-gray-800">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="mb-1 font-semibold text-gray-800 dark:text-gray-100">Managing teams (book)</h2>
      </div>
      {/* Meta */}
      ...
      <ul className="mt-3">
        <li className="flex items-center border-t border-gray-100 py-2 dark:border-gray-700/60">
          ...
          <div className="text-sm text-gray-400 line-through dark:text-gray-500">Implement new designs</div>
        </li>
        <li className="flex items-center border-t border-gray-100 py-2 dark:border-gray-700/60">
          <svg className="mr-2 h-3 w-3 shrink-0 fill-current text-gray-400 dark:text-gray-500" viewBox="0 0 12 12">
            <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
          </svg>
