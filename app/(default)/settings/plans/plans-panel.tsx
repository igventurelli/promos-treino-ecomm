  ...
  return (
    <div className="grow">
      ...
      <div className="space-y-6 p-6">
        ...
        <section>
          <div className="mb-8">
            <h2 className="mb-4 text-2xl font-bold text-gray-800 dark:text-gray-100">Plans</h2>
            <div className="text-sm">
              This workspace's Basic Plan is set to <strong className="font-medium">$34</strong> per month and will
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-6">
              {/* Tab 1 */}
              <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-sm xl:col-span-4 dark:border-gray-700/60 dark:bg-gray-800">
                <div className="absolute top-0 right-0 left-0 h-0.5 bg-green-500" aria-hidden="true"></div>
                <div className="border-b border-gray-200 px-5 pt-5 pb-6 dark:border-gray-700/60">
                  <header className="mb-2 flex items-center">
                    <div className="mr-3 h-6 w-6 shrink-0 rounded-full bg-green-500">
                      <svg className="h-6 w-6 fill-current text-white" viewBox="0 0 24 24">
                        <path d="M12 17a.833.833 0 01-.833-.833 3.333 3.333 0 00-3.334-3.334.833.833 0 110-1.666 3.333 3.333 0 003.334-3.334.833.833 0 111.666 0 3.333 3.333 0 003.334 3.334.833.833 0 110 1.666 3.333 3.333 0 00-3.334 3.334c0 .46-.373.833-.833.833z" />
                      </svg>
                    </div>
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Basic</h3>
                  </header>
                  <div className="mb-2 text-sm">
                    Ideal for individuals that need a custom solution with custom tools.
                  </div>
                  {/* Price */}
                  <div className="mb-4 font-bold text-gray-800 dark:text-gray-100">
                ...
                <div className="px-5 pt-4 pb-5">
                  <div className="mb-4 text-xs font-semibold text-gray-800 uppercase dark:text-gray-100">
                    What's included
                  </div>
                  {/* List */}
                  <ul>
              ...
              {/* Tab 2 */}
              <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-sm xl:col-span-4 dark:border-gray-700/60 dark:bg-gray-800">
                <div className="absolute top-0 right-0 left-0 h-0.5 bg-sky-500" aria-hidden="true"></div>
                <div className="border-b border-gray-200 px-5 pt-5 pb-6 dark:border-gray-700/60">
                  <header className="mb-2 flex items-center">
                    <div className="mr-3 h-6 w-6 shrink-0 rounded-full bg-sky-500">
                      <svg className="h-6 w-6 fill-current text-white" viewBox="0 0 24 24">
                        <path d="M12 17a.833.833 0 01-.833-.833 3.333 3.333 0 00-3.334-3.334.833.833 0 110-1.666 3.333 3.333 0 003.334-3.334.833.833 0 111.666 0 3.333 3.333 0 003.334 3.334.833.833 0 110 1.666 3.333 3.333 0 00-3.334 3.334c0 .46-.373.833-.833.833z" />
                      </svg>
                    </div>
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Standard</h3>
                  </header>
                  <div className="mb-2 text-sm">
                    Ideal for individuals that need a custom solution with custom tools.
                  </div>
              ...
              {/* Tab 3 */}
              <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-sm xl:col-span-4 dark:border-gray-700/60 dark:bg-gray-800">
                <div className="absolute top-0 right-0 left-0 h-0.5 bg-violet-500" aria-hidden="true"></div>
                <div className="border-b border-gray-200 px-5 pt-5 pb-6 dark:border-gray-700/60">
                  <header className="mb-2 flex items-center">
                    <div className="mr-3 h-6 w-6 shrink-0 rounded-full bg-violet-500">
                      <svg className="h-6 w-6 fill-current text-white" viewBox="0 0 24 24">
                        <path d="M12 17a.833.833 0 01-.833-.833 3.333 3.333 0 00-3.334-3.334.833.833 0 110-1.666 3.333 3.333 0 003.334-3.334.833.833 0 111.666 0 3.333 3.333 0 003.334 3.334.833.833 0 110 1.666 3.333 3.333 0 00-3.334 3.334c0 .46-.373.833-.833.833z" />
                      </svg>
                    </div>
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Plus</h3>
                  </header>
                  <div className="mb-2 text-sm">
                    Ideal for individuals that need a custom solution with custom tools.
                  </div>
        ...
        {/* Contact Sales */}
        <section>
          <div className="rounded-lg bg-linear-to-r from-violet-500/[0.12] to-violet-500/[0.04] px-5 py-3 text-center xl:flex xl:flex-wrap xl:items-center xl:justify-between xl:text-left dark:from-violet-500/[0.24]">
            <div className="mb-2 font-semibold text-gray-800 xl:mb-0 dark:text-gray-100">
        ...
        <section>
          <div className="my-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">FAQs</h2>
          </div>
          <ul className="space-y-5">
            ...
            <li>
              ...
              <div className="text-sm">
                ...
                laborum in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
              </div>
            </li>
            <li>
              <div className="mb-1 font-semibold text-gray-800 dark:text-gray-100">Got more questions?</div>
              <div className="text-sm">
                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
                laborum in voluptate velit esse cillum dolore eu fugiat{" "}
