    ...
    <div className="mx-auto w-full max-w-[96rem] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-5 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl font-bold text-gray-800 md:text-3xl dark:text-gray-100">Search For Jobs</h1>
        </div>
      ...
      <div className="mt-9 flex flex-col space-y-10 sm:flex-row sm:space-y-0 sm:space-x-6 md:flex-col md:space-y-10 md:space-x-0 xl:flex-row xl:space-y-0 xl:space-x-6">
        ...
        <div className="w-full">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="text-sm text-gray-500 italic dark:text-gray-400">Showing 289 Jobs</div>
            {/* Sort */}
