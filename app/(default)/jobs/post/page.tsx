    ...
    <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex max-w-5xl flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          ...
          <div className="mb-2 text-sm text-gray-500 italic dark:text-gray-400">Posted Jan 6, 2024</div>
          ...
          <div className="mb-6 rounded-xl bg-white p-5 shadow-lg lg:hidden dark:bg-gray-800">
            <div className="mb-6 text-center">
              <div className="mb-3 inline-flex">
                <Image className="h-16 w-16 rounded-full" src={Image06} width={64} height={64} alt="Company 01" />
              </div>
              <div className="mb-1 text-lg font-bold text-gray-800 dark:text-gray-100">Revolut Ltd</div>
              <div className="text-sm text-gray-500 italic dark:text-gray-400">179 Jobs Posted</div>
            </div>
          ...
          <div className="mb-6">
            <div className="-m-1 flex flex-wrap items-center">
              <div className="m-1">
                <a
                  className="btn-xs rounded-full border-gray-200 px-2.5 py-1 text-xs text-gray-800 shadow-none hover:border-gray-300 dark:border-gray-700/60 dark:text-gray-300 dark:hover:border-gray-600"
                  href="#0"
                >
                  Full-time
                </a>
          ...
          {/* The Role */}
          <div>
            <h2 className="mb-2 text-xl leading-snug font-bold text-gray-800 dark:text-gray-100">The Role</h2>
            <div className="space-y-6">
              ...
              <p>
                ...
                business practices rapidly increasing economic value. While the realm of the human sciences has used the
                power afforded by computational capabilities to solve many human based dilemmas. Even the art scene has
                adopted carefully selected ML applications to usher in the technological movement.
              </p>
              <p>
                Join us every second Wednesday as we host an open discussion about the amazing things happening in the
                world of AI and machine learning. Feel free to share your experiences, ask questions, ponder the
          ...
          {/* About You */}
          <div>
            <h2 className="mb-2 text-xl leading-snug font-bold text-gray-800 dark:text-gray-100">About You</h2>
            <div className="space-y-6">
              <p>
                You love building great software. Your work could be supporting new feature development, migrating
                existing features, and creating other mobile and web solutions for customers. You'll have a primary
                focus on frontend development using Javascript. Our client's tech stack is JavaScript, primarily using
                React. A strong understanding of JS core (ES2019+) is required, with some exposure in Java as back-end
                technology. We use modern tools, which means you'll have the opportunity to work with Webpack, Redux,
                Apollo, Styled Components, and much more.
              </p>
              <p>
                You love learning. Engineering is an ever-evolving world. You enjoy playing with new tech and exploring
                areas that you might not have experience with yet. You are self-driven, self-learner willing to share
                knowledge and participate actively in your community.
              </p>
              <p>
                Having overlap with your team is critical when working in a global remote team. Modus requires all team
                members to overlap with EST morning hours daily. In addition, reliable high speed internet is a must.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                <div className="mr-4 text-sm text-gray-500 italic dark:text-gray-400">Share:</div>
                <div className="flex items-center space-x-3">
                  <button className="text-gray-400 hover:text-violet-500 dark:text-gray-500 dark:hover:text-violet-500">
          ...
          {/* Related Jobs */}
          <div>
            <h2 className="mb-6 text-xl leading-snug font-bold text-gray-800 dark:text-gray-100">Related Jobs</h2>
        ...
        <div className="hidden space-y-4 lg:block">
          ...
          <div className="rounded-xl bg-white p-5 shadow-sm lg:w-[18rem] xl:w-[20rem] dark:bg-gray-800">
            <div className="mb-6 text-center">
              <div className="mb-3 inline-flex">
                <Image className="h-16 w-16 rounded-full" src={Image06} width={64} height={64} alt="Company 01" />
              </div>
