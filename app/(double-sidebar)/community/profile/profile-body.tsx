...
export default function ProfileBody() {
  ...
  return (
    <div
      className={`flex grow flex-col bg-white transition-transform duration-300 ease-in-out md:translate-x-0 dark:bg-gray-900 ${
      ...
      <div className="relative px-4 pb-8 sm:px-6">
        ...
        <div className="-mt-16 mb-6 sm:mb-3">
          <div className="flex flex-col items-center sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex space-x-2 sm:mb-2">
              <button className="shrink-0 rounded-lg border border-gray-200 bg-white p-1.5 shadow-sm hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:hover:border-gray-600">
                <svg className="h-1 w-4 fill-current text-gray-400" viewBox="0 0 16 4">
        ...
        <header className="mb-6 text-center sm:text-left">
          ...
          <div className="mb-2 inline-flex items-start">
            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Carolyn McNeail</h1>
            <svg className="ml-2 shrink-0 fill-current text-yellow-500" width="16" height="16" viewBox="0 0 16 16">
        ...
        <div className="relative mb-6">
          <div className="absolute bottom-0 h-px w-full bg-gray-200 dark:bg-gray-700/60" aria-hidden="true"></div>
          <ul className="no-scrollbar relative -mx-4 flex flex-nowrap overflow-x-scroll text-sm font-medium sm:-mx-6 lg:-mx-8">
            <li className="mr-6 first:pl-4 last:mr-0 last:pr-4 sm:first:pl-6 sm:last:pr-6 lg:first:pl-8 lg:last:pr-8">
              <a className="block border-b-2 border-violet-500 pb-3 whitespace-nowrap text-violet-500" href="#0">
                General
              </a>
            </li>
            <li className="mr-6 first:pl-4 last:mr-0 last:pr-4 sm:first:pl-6 sm:last:pr-6 lg:first:pl-8 lg:last:pr-8">
        ...
        <div className="flex flex-col xl:flex-row xl:space-x-16">
          ...
          <div className="mb-8 flex-1 space-y-5 xl:mb-0">
            {/* About Me */}
            <div>
              <h2 className="mb-2 font-semibold text-gray-800 dark:text-gray-100">About Me</h2>
            ...
            {/* Departments */}
            <div>
              <h2 className="mb-2 font-semibold text-gray-800 dark:text-gray-100">Departments</h2>
              {/* Cards */}
              <div className="grid gap-4 xl:grid-cols-2">
                {/* Card */}
                <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700/60 dark:bg-gray-900">
                  {/* Card header */}
            ...
            {/* Work History */}
            <div>
              <h2 className="mb-2 font-semibold text-gray-800 dark:text-gray-100">Work History</h2>
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700/60 dark:bg-gray-900">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center text-sm sm:grow">
                      ...
                      <div className="my-2 mr-3 h-8 w-8 shrink-0 rounded-full bg-yellow-500">
                        <svg className="h-8 w-8 fill-current text-yellow-50" viewBox="0 0 32 32">
                    ...
                    <div className="mt-2 sm:mt-0 sm:ml-2">
                      <ul className="-m-1 flex flex-wrap sm:justify-end">
                        <li className="m-1">
                          <button className="inline-flex items-center justify-center rounded-full border border-gray-200 bg-white px-2.5 py-0.5 text-xs leading-5 font-medium text-gray-500 shadow-sm transition hover:border-gray-300 dark:border-gray-700/60 dark:bg-gray-800 dark:text-gray-400 dark:hover:border-gray-600">
                            Marketing
                          </button>
                        </li>
                        <li className="m-1">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center text-sm sm:grow">
                      ...
                      <div className="my-2 mr-3 h-8 w-8 shrink-0 rounded-full bg-violet-500">
                        <svg className="h-8 w-8 fill-current text-violet-50" viewBox="0 0 32 32">
