    ...
    >
      ...
      <div className="grow px-4 py-4 sm:px-6 md:px-5">
        ...
        <header className="mb-4 sm:flex sm:items-start sm:justify-between">
          <h1 className="mb-1 ml-2 text-xl leading-snug font-bold text-gray-800 sm:mb-0 dark:text-gray-100">
            Chill your mind with this amazing offer 🎉
          </h1>
          <button className="inline-flex rounded-full bg-sky-500/20 px-2.5 py-1 text-center text-xs font-medium whitespace-nowrap text-sky-700">
            Exciting news
          </button>
        </header>
