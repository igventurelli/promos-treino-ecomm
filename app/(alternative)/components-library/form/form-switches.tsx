...
export default function FormSwitches() {
  ...
  return (
    <div>
      <h2 className="mb-6 text-2xl font-bold text-gray-800 dark:text-gray-100">Toggle Switch</h2>
      <div className="-m-3 flex flex-wrap items-center">
        <div className="m-3 w-24">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2 text-sm text-gray-400 italic dark:text-gray-500">{toggle1 ? "On" : "Off"}</div>
          </div>
          {/* End */}
        </div>
        ...
        <div className="m-3 w-24">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2 text-sm text-gray-400 italic dark:text-gray-500">{toggle2 ? "On" : "Off"}</div>
          </div>
          {/* End */}
        </div>
        ...
        <div className="m-3 w-32">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2 text-sm text-gray-400 italic dark:text-gray-500">Disabled</div>
          </div>
          {/* End */}
        </div>
      </div>
