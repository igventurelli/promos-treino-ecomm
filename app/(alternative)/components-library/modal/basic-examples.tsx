...
export default function BasicExamples() {
  ...
  return (
    <div>
      <h2 className="mb-6 text-2xl font-bold text-gray-800 dark:text-gray-100">Basic</h2>
      <div className="-m-1.5 flex flex-wrap items-center">
          ...
          <ModalBasic isOpen={basicModalOpen} setIsOpen={setBasicModalOpen} title="Basic Modal">
            ...
            <div className="px-5 pt-4 pb-1">
              <div className="text-sm">
                <div className="mb-2 font-medium text-gray-800 dark:text-gray-100">Let's Talk Paragraph</div>
        ...
        <div className="m-1.5">
          ...
          <ModalBasic isOpen={scrollbarModalOpen} setIsOpen={setScrollbarModalOpen} title="Modal w/ Scroll Bar">
            ...
            <div className="px-5 py-4">
              <div className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    Ullamcorper malesuada proin libero nunc consequat interdum varius sit. Nec sagittis aliquam
                    malesuada bibendum arcu vitae elementum curabitur vitae. Mattis enim ut tellus elementum el
                    fringilla est ullamcorper eget nulla. Enim eu turpis egestas pretium aenean pharetra magna. Aliquam
                    id diam maecenas ultricies mi eget us mauris vitae ultricies leo integer t malesuada fames ac turpis
                    egestas maecenas pharetra volutpat lacus laoreet non.
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua.
            ...
            {/* Modal footer */}
            <div className="sticky bottom-0 border-t border-gray-200 bg-white px-5 py-4 dark:border-gray-700/60 dark:bg-gray-800">
              <div className="flex flex-wrap justify-end space-x-2">
                <button
                  className="btn-sm border-gray-200 text-gray-800 hover:border-gray-300 dark:border-gray-700/60 dark:text-gray-300 dark:hover:border-gray-600"
                  onClick={() => {
